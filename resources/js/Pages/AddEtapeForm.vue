                ...
                <div class="p-6 text-gray-900"> 
                    <div class="container mt-5">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="ville_depart" v-model="form.ville_depart" :disabled="etape_id!==null" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="ville_arrivee" v-model="form.ville_arrivee" :disabled="etape_id!==null" required>
                            <div v-if="errors.ville_arrivee" class="text-danger">{{ errors.ville_arrivee[0] }} </div>
                        </div>
                        <div class="mb-3">
                            <label for="distance" class="form-label">Distance</label>
                            <input type="number" class="form-control custom-input" id="distance" v-model="form.distance" :disabled="etape_id!==null" required>
                            <div v-if="errors.distance" class="text-danger">{{ errors.distance[0] }} </div>
                        </div>
                        <div class="mb-3">
                            <label for="denivele" class="form-label">Dénivelé</label>
                            <input type="number" class="form-control custom-input" id="denivele" v-model="form.denivele" :disabled="etape_id!==null" required>
                            <div v-if="errors.denivele" class="text-danger">{{ errors.denivele[0] }} </div>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">Description</label>
                            <textarea class="form-control custom-input" id="description" v-model="form.description" rows="5" :disabled="etape_id!==null" required></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control custom-input" id="numero_etape" v-model="form.numero_etape" :disabled="etape_id!==null" required>
                            <div v-if="errors.numero_etape" class="text-danger">{{ errors.numero_etape[0] }} </div>
                        </div>
                            
                        <button type="submit" class="btn custom-btn" :disabled="etape_id!==null" >Créer l'étape</button>
                        </form>
                    </div>
                </div>
            </div>
